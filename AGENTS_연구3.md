...
- **`screener.py` (3대 핵심 전략 스크리너)**:
  ...
  - **`screen_strategy3_sugeub_halt()`**: 최근 20일 메이저(외국인/기관) 누적 수급 100억 원+ 이상 및 기타법인 수급이 유입되며 바닥/상승 이평선을 핥고 지지받는 수급 바닥/안착형 정석 패턴을 포착합니다. (고점 제한 해제로 한국항공우주, 자이에스앤디 등 모든 메이저 수급주 전수 포함)

def get_static_schedules():
    static_events = [
        ...
        {"date": "2026-07-29", "category": "거시 일정", "event": "미국 FOMC 금리결정 발표 ★", "source": "정적 캘린더"},
        {"date": "2026-08-12", "category": "거시 일정", "event": "미국 7월 소비자물가지수 (CPI) 발표", "source": "정적 캘린더"},
        {"date": "2026-09-16", "category": "거시 일정", "event": "미국 FOMC 금리결정 및 분기 전망 점도표 발표 ★★", "source": "정적 캘린더"},
        {"date": "2026-09-16", "category": "거시 일정", "event": "미국 8월 소비자물가지수 (CPI) 발표", "source": "정적 캘린더"},
        {"date": "2026-10-14", "category": "거시 일정", "event": "미국 9월 소비자물가지수 (CPI) 발표", "source": "정적 캘린더"},
        {"date": "2026-10-28", "category": "거시 일정", "event": "미국 FOMC 금리결정 발표 ★", "source": "정적 캘린더"},
        {"date": "2026-11-12", "category": "거시 일정", "event": "미국 10월 소비자물가지수 (CPI) 발표", "source": "정적 캘린더"},
        {"date": "2026-12-11", "category": "거시 일정", "event": "미국 11월 소비자물가지수 (CPI) 발표", "source": "정적 캘린더"},
        {"date": "2026-12-16", "category": "거시 일정", "event": "미국 FOMC 금리결정 발표 ★", "source": "정적 캘린더"}
    ]

...
# ── 구글 알리미 RSS (VIP 방문, 정부 정책, 입법 모멘텀 피드) ───────────
VIP_RSS_FEEDS = [
    "https://www.google.co.kr/alerts/feeds/13636798368499168881/2647445553520014659",  # VIP 1: 국빈방문 / 정상회담
    "https://www.google.co.kr/alerts/feeds/13636798368499168881/9785744301701654080",  # VIP 2: 빅테크 거물 회동 / 비공개
    "https://www.google.co.kr/alerts/feeds/13636798368499168881/8203039951955249401",  # 1번: 정부 부처 보도자료 / 정책 발표 / 대책
    "https://www.google.co.kr/alerts/feeds/13636798368499168881/13116178950733243781", # 3번: 국회 입법 / 법안 통과 / 개정안
]

# VIP 1차 필터 키워드 (방문, 회동, 정책발표, 입법통과 포함)
VIP_KEYWORDS = [
    '방한', '회동', '방중', '방문', '만난다', '논의', '독대', '방일', '국빈', '정상회담', 'MOU', '비공개',
    '보도자료', '정책발표', '육성방안', '대책', '로드맵', '지원방안', '법안', '개정안', '통과', '발의', '수주', '투자유치'
]

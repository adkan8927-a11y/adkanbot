...
OUTPUT_MD_PATH = f"reports/{month_str}/{date_str}_장전.md"

SIMILARITY_THRESHOLD = 0.50  # Title-Only 임베딩 최적 임계치 (0.60 -> 0.50)
...
def main():
    ...
    OUTPUT_MD_PATH = f"reports/{target_month_str}/{target_date_str}_장전.md"
